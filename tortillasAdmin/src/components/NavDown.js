...
import { faListUl,faFileInvoiceDollar,faPaperPlane } from '@fortawesome/free-solid-svg-icons';
...
export default function NavDown(){
    ...
    return (
        <div className={ pathname =="/logIn"? "invisible" : "w-100 down d-flex bg-custom"}>
            ...
            <div className=' col d-flex justify-content-center align-items-center'>
                <Link to="/Consultas"><FontAwesomeIcon icon={faListUl} className={place("/Consultas")}/></Link>
            </div>
        </div>
    );
};